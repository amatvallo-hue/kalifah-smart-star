...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kalifah.my — Belajar Sambil Seronok" },
      { property: "og:description", content: "Kuiz interaktif, latihan dan ganjaran bintang untuk anak-anak Malaysia." },
