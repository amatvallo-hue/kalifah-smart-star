...
const BIDANG_CONFIG: Record<string, AktivitiConfig[]> = {
  bahasa: [
    ...
    },
    {
      ...
      tajukEn: "Complete the Letters",
      mesejSelesai: "Syabas! Kamu dah pandai susun huruf!",
      mesejSelesaiEn: "Great job! You know how to arrange letters!",
      jenis: "lengkap",
      ikon: PencilRuler,
    },
    {
      ...
      mesejSelesaiEn: "Great job! You know your animals!",
      jenis: "kosa-kata",
      ikon: PawPrint,
    },
    {
...

    {
      ...
      mesejSelesaiEn: "Great job! You know your body parts!",
      jenis: "kosa-kata",
      ikon: PersonStanding,
    },
  ],
  kognitif: [
    {
      ...
      tajuk: "Kira Bersama",
      tajukEn: "Count Together",
      mesejSelesai: "Syabas! Kamu dah pandai kira!",
      mesejSelesaiEn: "Great job! You know how to count!",
      jenis: "kira",
      ikon: Star,
    },
    {
      ...
      tajuk: "Pilih Nombor",
      tajukEn: "Choose the Number",
      mesejSelesai: "Syabas! Kamu dah kenal nombor!",
      mesejSelesaiEn: "Great job! You know your numbers!",
      jenis: "nombor",
      ikon: Hash,
    },
    {
      ...
      mesejSelesaiEn: "Great job! You know your colors!",
      jenis: "warna",
      ikon: Palette,
    },
    {
      ...
      mesejSelesaiEn: "Great job! You know your shapes!",
      jenis: "bentuk",
      ikon: Shapes,
    },
  ],
  kerohanian: [
    {
      ...
      tajuk: "Adab Harian",
      tajukEn: "Daily Manners",
      mesejSelesai: "Syabas! Kamu budak yang baik!",
      mesejSelesaiEn: "Great job! You're a well-mannered kid!",
      jenis: "adab",
      ikon: HandHeart,
    },
  ],
